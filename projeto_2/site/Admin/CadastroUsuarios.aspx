        ...
        <div class="row">
            ...
            <div class="col-6">
                <div class="box margin-right-20 border">
                    ...
                    <asp:Label ID="Codigo" class="destaque" runat="server" Text=""></asp:Label>
                    <br />
            ...
            <div class="col-6">
                ...
                <div class="box margin-left-20 border">
                    <asp:GridView ID="ViewUsuarios" AutoGenerateColumns="true" AutoGenerateSelectButton="true" OnSelectedIndexChanged="ViewUsuarios_SelectedIndexChanged1" runat="server"></asp:GridView>
